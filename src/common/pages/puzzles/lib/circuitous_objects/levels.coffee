        ...
        stages: [
            {
                ...
                levels: [
                    ...
                    }
                    {
                        ...
                        hints: [
                            'The electrons will flow down the path of least resistance (as in the short circuit).'
                            'If you draw wire that allows the electrons to bypass one of the lightbulbs they will take that path..'
                            'Draw wire on either side of the battery connecting to the top part of the circuit going around one of the lightbulbs.'
                        ]
                ...
                levels: [
                    {
                        ...
                        instructions: {"components": [{"name": "Battery", "position": "12,9", "voltage": 12},{"name": "Battery", "position": "6,9"},{"name": "Lightbulb", "position": "9,4"}],"wires": []}
                        hints: [
                            'The voltage designates how much electricity the battery will provide to the current. The greater the voltage, the more current a circuit will have.'
                            'Each battery lists its voltage on the front.'
                            'Create a circuit using the battery that says 12V on it.'
                        ]
                        completeInstructions: {"components": [{"name": "Battery", "position": "12,9", "voltage": 12},{"name": "Battery", "position": "6,9"},{"name": "Lightbulb", "position": "9,4"}],"wires": [["12,9","11,9"],["11,9","10,9"],["10,9","9,9"],["9,9","9,8"],["9,8","9,7"],["9,7","9,6"],["9,6","9,5"],["9,5","9,4"],["13,9","13,8"],["13,8","13,7"],["13,7","13,6"],["13,6","13,5"],["13,5","13,4"],["13,4","12,4"],["12,4","11,4"],["11,4","10,4"]]}
                        completeValues: [["Battery",2.4],["Lightbulb",2.4]]
                        complete: '''
                            <p>The more voltage provided to a circuit, the greater the current.</p>
                    ...
                    }
                    {
                        ...
                        instructions: {"components": [{"name": "Battery", "position": "12,9", "voltage": 12},{"name": "Battery", "position": "6,9"},{"name": "Resistor", "position": "6,2"},{"name": "Lightbulb", "position": "12,4"}],"wires": []}
                        hints: [
                            'You can see how much resistance each component has on the tag. For example the lightbulb provide 5 Ohms of resistance.'
                            'The more resistance in a circuit, the less current there will be.'
                            'Create a circuit using the Resistor with 10 Ohms of resistance.'
                        ]
                        completeInstructions: {"components": [{"name": "Battery", "position": "12,9", "voltage": 12},{"name": "Battery", "position": "6,9"},{"name": "Lightbulb", "position": "9,4"}],"wires": [["12,9","11,9"],["11,9","10,9"],["10,9","9,9"],["9,9","9,8"],["9,8","9,7"],["9,7","9,6"],["9,6","9,5"],["9,5","9,4"],["13,9","13,8"],["13,8","13,7"],["13,7","13,6"],["13,6","13,5"],["13,5","13,4"],["13,4","12,4"],["12,4","11,4"],["11,4","10,4"]]}
                        completeValues: [["Resistor",'used']]
                        complete: '''
                            <p>Resistance (Ohms) is inversely related to the amount of current in a circuit. As resistance increases, current decreases.</p>
                    ...
                    }
                    {
                        ...
                        instructions: {"components": [{"name": "Battery", "position": "12,9", "voltage": 12},{"name": "Battery", "position": "6,9"},{"name": "Resistor", "position": "6,2"},{"name": "Lightbulb", "position": "12,4"}],"wires": []}
                        hints: [
                            'The amount of current (Amps) in the circuit is displayed on the tag of each component. Each tag will display 0 Amps until the circuit is complete.'
                            'The amount of current goes up as more volts are added and down as more resistance is added.'
                            'Create a circuit using the 12 Volt battery and the resistor with 10 Ohms.'
                        ]
                        completeInstructions: {"components": [{"name": "Battery", "position": "12,9", "voltage": 12},{"name": "Battery", "position": "6,9"},{"name": "Lightbulb", "position": "9,4"}],"wires": [["12,9","11,9"],["11,9","10,9"],["10,9","9,9"],["9,9","9,8"],["9,8","9,7"],["9,7","9,6"],["9,6","9,5"],["9,5","9,4"],["13,9","13,8"],["13,8","13,7"],["13,7","13,6"],["13,6","13,5"],["13,5","13,4"],["13,4","12,4"],["12,4","11,4"],["11,4","10,4"]]}
                        completeValues: [["Battery",1.2]]
                        complete: '''
                            <p>Current (Amps) in a circuit is related to the amount of resistance (Ohms) and voltage (Volts) in a circuit.</p>
                    ...
                    }
                    {
                        ...
                        instructions: {"components": [{"name": "Battery", "position": "8,9"},{"name": "Lightbulb", "position": "8,5"}],"wires": [["9,8","9,7"],["9,7","9,6"],["9,6","9,5"],["9,8","9,9"],["8,5","8,6"],["8,6","8,7"],["8,7","8,8"],["8,8","8,9"]]}
                        hints: [
                            'You can change the resistance in the lightbulb by mousing over it\'s tag and clicking the pencil icon.'
                            'The lightbulb currently provides 5 Ohms of resistance. The more resistance a circuit has, the less current it will have.'
                            'Change the value of the lightbulb\'s resistance in the edit dialog to 10.'
                        ]
                        completeInstructions: {"components": [{"name": "Battery", "position": "8,9"},{"name": "Lightbulb", "position": "8,5", "resistance": 10}],"wires": [["9,8","9,7"],["9,7","9,6"],["9,6","9,5"],["9,8","9,9"],["8,5","8,6"],["8,6","8,7"],["8,7","8,8"],["8,8","8,9"]]}
                        completeValues: [["Battery",0.9],["Lightbulb",0.9]]
                        complete: '''
                            <p>With 9 Volts of electricity, changing the resistance of the lightbulb to 10 Ohms causes the current to decrease to 0.9 Amps.</p>
                        '''
                        values: true                        
                    }
                    {
                        ...
                        instructions: {"components": [{"name": "Battery", "position": "8,9"},{"name": "Resistor", "position": "6,4"}],"wires": [["8,9","7,9"],["7,9","6,9"],["6,9","6,8"],["6,8","6,7"],["6,4","6,3"],["6,3","7,3"],["7,3","8,3"],["8,3","9,3"],["9,3","10,3"],["10,3","11,3"],["11,9","11,8"],["11,8","11,7"],["11,7","11,6"],["11,9","10,9"],["10,9","9,9"],["11,5","11,4"],["11,4","11,3"],["11,5","11,6"]]}
                        hints: [
                            'You can change the voltage in the battery by mousing over it\'s tag and clicking the pencil icon.'
                            'The battery currently provides 9 Volts of electricity. The more volts the battery provides, the more current the circuit will have.'
                            'Change the value of the battery\'s voltage in the edit dialog to 12.'
                        ]
                        completeInstructions: {"components": [{"name": "Battery", "position": "8,9", "voltage": 12},{"name": "Resistor", "position": "6,4"}],"wires": [["8,9","7,9"],["7,9","6,9"],["6,9","6,8"],["6,8","6,7"],["6,4","6,3"],["6,3","7,3"],["7,3","8,3"],["8,3","9,3"],["9,3","10,3"],["10,3","11,3"],["11,9","11,8"],["11,8","11,7"],["11,7","11,6"],["11,9","10,9"],["10,9","9,9"],["11,5","11,4"],["11,4","11,3"],["11,5","11,6"]]}
                        completeValues: [["Battery",1.2],["Resistor",1.2]]
                        complete: '''
                            <p>With 12 Volts of electricity and 10 Ohms of resistance from the resistor the circuit will have 1.2 Amps of current.</p>
                        '''
                        values: true                        
                    }
                ]
                ...
                levels: [
                    {
                        ...
                        instructions: {"components": [{"name": "Battery", "position": "8,8"},{"name": "Lightbulb", "position": "7,4"},{"name": "Lightbulb", "position": "13,3"}],"wires": [["9,8","9,7"],["9,7","10,7"],["10,7","10,6"],["10,6","11,6"],["11,6","11,5"],["11,5","11,4"],["11,4","10,4"],["10,4","9,4"],["9,4","8,4"],["7,4","6,4"],["6,4","6,5"],["6,5","6,6"],["6,6","7,6"],["7,6","7,7"],["7,7","8,7"],["8,7","8,8"]]}
                        hints: [
                            'You\'ll need to erase some wire to connect the second lightbulb to the circuit "in series".'
                            'Two lightbulbs placed next to each other in a circuit are said to be "in series" and add twice as much resistance to the circuit as one lightbulb would.'
                            'Erase a bit of the top of the circuit and add the other lighbulb to the circuit.'
                        ]
                        completeInstructions: {"components": [{"name": "Battery", "position": "8,8"},{"name": "Lightbulb", "position": "7,4"},{"name": "Lightbulb", "position": "9,4"}],"wires": [["9,8","9,7"],["9,7","10,7"],["10,7","10,6"],["10,6","11,6"],["11,6","11,5"],["11,5","11,4"],["7,4","6,4"],["6,4","6,5"],["6,5","6,6"],["6,6","7,6"],["7,6","7,7"],["7,7","8,7"],["8,7","8,8"],["8,4","9,4"],["11,4","10,4"]]}
                    ...
                    }
                    {
                        ...
                        instructions: {"components": [{"name": "Lightbulb", "position": "8,7"},{"name": "Battery", "position": "8,10"},{"name": "Lightbulb", "position": "12,3"}],"wires": [["9,10","10,10"],["10,10","11,10"],["11,9","11,8"],["11,8","11,7"],["11,7","10,7"],["10,7","9,7"],["11,9","11,10"],["8,7","7,7"],["7,7","6,7"],["6,7","6,8"],["6,8","6,9"],["6,9","6,10"],["6,10","7,10"],["7,10","8,10"],["11,7","11,6"],["11,6","11,5"],["11,5","11,4"],["11,4","11,3"],["11,3","10,3"],["10,3","9,3"],["6,7","6,6"],["6,6","6,5"],["6,5","6,4"],["6,4","6,3"],["6,3","7,3"],["7,3","8,3"]]}
                        hints: [
                            'You don\'t really need a hint for this one, but pay attention to what happens to the current coming from the battery when you add the second lightbulb.'
                            'The circuit will behave differently this time because the electrons have two paths to go down.'
                            'Drag and drop the lightbulb in to the blank spot and notice that the lightbulb in the circuit does not change but the current from the battery does.'
                        ]
                        completeInstructions: {"components": [{"name": "Lightbulb", "position": "8,7"},{"name": "Battery", "position": "8,10"},{"name": "Lightbulb", "position": "8,3"}],"wires": [["9,10","10,10"],["10,10","11,10"],["11,9","11,8"],["11,8","11,7"],["11,7","10,7"],["10,7","9,7"],["11,9","11,10"],["8,7","7,7"],["7,7","6,7"],["6,7","6,8"],["6,8","6,9"],["6,9","6,10"],["6,10","7,10"],["7,10","8,10"],["11,7","11,6"],["11,6","11,5"],["11,5","11,4"],["11,4","11,3"],["11,3","10,3"],["10,3","9,3"],["6,7","6,6"],["6,6","6,5"],["6,5","6,4"],["6,4","6,3"],["6,3","7,3"],["7,3","8,3"]]}
                        completeValues: [["Lightbulb",1.8],["Battery",3.6],["Lightbulb",1.8]]
                        complete: '''
                            <p>This is called a Parallel Circuit because each lightbulb has it\'s own path to the battery.</p>
                    ...
                    }
                    {
                        ...
                        instructions: {"components": [{"name": "Battery", "position": "8,10"},{"name": "Lightbulb", "position": "8,8"},{"name": "Lightbulb", "position": "8,4"}],"wires": []}
                        hints: [
                            'To create a parallel circuit you need to give both lightbulbs a path to the battery that doesn\'t touch the other lightbulb.'
                            'Draw a circuit containing the first lightbulb and then draw a circuit using the same battery containing the second lightbulb.'
                            'You should be able to trace a line along the wires to each lightbulb without hitting the other lightbulb.'
                        ]
                        completeInstructions: {"components": [{"name": "Battery", "position": "8,10"},{"name": "Lightbulb", "position": "8,8"},{"name": "Lightbulb", "position": "8,4"}],"wires": [["9,10","10,10"],["10,10","11,10"],["11,10","11,9"],["11,9","11,8"],["11,8","10,8"],["10,8","9,8"],["8,10","7,10"],["7,10","6,10"],["6,10","6,9"],["6,9","6,8"],["6,8","7,8"],["7,8","8,8"],["6,8","6,7"],["6,7","6,6"],["6,6","6,5"],["6,5","6,4"],["6,4","7,4"],["7,4","8,4"],["9,4","10,4"],["10,4","11,4"],["11,5","11,6"],["11,6","11,7"],["11,7","11,8"],["11,4","11,5"]]}
                        completeValues: [["Battery",3.6],["Lightbulb",1.8],["Lightbulb",1.8]]
                        complete: '''
                            <p>In this parallel circuit each lightbulb draws 1.8 Amps of current from the battery.</p>
                    ...
                    }
                    {
                        ...
                        instructions: {"components": [{"name": "Battery", "position": "8,10"},{"name": "Lightbulb", "position": "8,8"},{"name": "Lightbulb", "position": "8,4"}],"wires": []}
                        hints: [
                            'You\'ll need to create either a series circuit or a parallel circuit.'
                            'The position of the lightbulbs is not relevant to the challenge.'
                            'Create a series circuit by drawing one line of wire that connects the battery to both lightbulbs.'
                        ]
                        completeInstructions: {"components": [{"name": "Battery", "position": "8,10"},{"name": "Lightbulb", "position": "8,4"},{"name": "Lightbulb", "position": "8,8"}],"wires": [["9,10","10,10"],["10,10","11,10"],["11,10","11,9"],["11,9","11,8"],["11,8","10,8"],["10,8","9,8"],["8,8","7,8"],["7,8","7,7"],["7,7","7,6"],["7,6","7,5"],["7,5","8,5"],["8,5","9,5"],["9,5","10,5"],["10,5","10,4"],["10,4","9,4"],["8,4","7,4"],["7,4","6,4"],["6,4","6,5"],["6,5","6,6"],["6,6","6,7"],["6,7","6,8"],["6,8","6,9"],["6,9","6,10"],["6,10","7,10"],["7,10","8,10"]]}
                        completeValues: [["Lightbulb",0.9],["Lightbulb",0.9]]
                        complete: '''
                            <p>A series circuit creates enough resistance (10 Ohms) from the two lightbulbs to create 0.9 Amps of electricity from the 9 Volt battery.</p>
                    ...
                    }
                    {
                        ...
                        instructions: {"components": [{"name": "Battery", "position": "8,10"},{"name": "Lightbulb", "position": "8,3"},{"name": "Lightbulb", "position": "4,7"},{"name": "Lightbulb", "position": "8,7"}],"wires": []}
                        hints: [
                            'You\'ll need to create either a series circuit or a parallel circuit.'
                            'In order to put all of the lightbulbs in parallel you\'ll need to connect each to the battery without touching the others.'
                            'Create a parallel circuit by drawing three paths from the battery to each lightbulb.'
                        ]
                        completeInstructions: {"components": [{"name": "Battery", "position": "8,10"},{"name": "Lightbulb", "position": "8,3"},{"name": "Lightbulb", "position": "4,7"},{"name": "Lightbulb", "position": "8,7"}],"wires": [["9,10","10,10"],["10,10","11,10"],["11,3","10,3"],["10,3","9,3"],["8,3","7,3"],["7,3","6,3"],["7,10","8,10"],["11,10","11,9"],["11,9","11,8"],["11,8","11,7"],["11,7","11,6"],["11,6","11,5"],["11,5","11,4"],["11,4","11,3"],["6,10","6,9"],["6,9","6,8"],["6,8","6,7"],["6,7","6,6"],["6,6","6,5"],["6,5","6,4"],["6,4","6,3"],["7,10","6,10"],["6,7","5,7"],["4,7","3,7"],["3,7","3,8"],["3,8","3,9"],["3,9","3,10"],["3,10","3,11"],["3,11","3,12"],["3,12","4,12"],["4,12","4,13"],["4,13","5,13"],["5,13","6,13"],["6,13","7,13"],["7,13","8,13"],["8,13","9,13"],["9,13","10,13"],["10,13","10,12"],["10,12","10,11"],["10,11","10,10"],["9,10","9,9"],["9,9","9,8"],["9,8","9,7"],["8,10","8,9"],["8,9","8,8"],["8,8","8,7"]]}
                        completeValues: [["Lightbulb",1.8],["Lightbulb",1.8],["Lightbulb",1.8]]
                        complete: '''
                            <p>All three of the lightbulbs can be placed in parallel, each drawing 1.8 Amps of current from the battery.</p>
                ...
                levels: [
                    {
                        ...
                        hints: [
                            'The tags will show how much resistance (ohms) each component provides and how much current (amps) is flowing through each component.'
                            'The less resistance a circuit has, the more current it will have..'
                            'Add the lightbulb (5 Ohms of resistance) only to create a circuit with the maximum amount of current.'
                        ]
                        ...
                        complete: '''
                            <p>The less resistance a circuit has, the more current it will have.</p>
                    ...
                    }
                    {
                        ...
                        hints: [
                            ...
                            'The amount of current in the circuit is directly related to the amount of voltage and resistance. Current = Voltage / Resistance'
                            'Create a circuit connecting the battery to the lightbulb to create 1.8 Amps of current. <br/> 1.8 Amps = 9 Volts / 5 Ohms'
                        ]
                    ...
                    }
                    {
                        ...
                        instructions: {"components": [{"name": "Battery", "position": "8,10"},{"name": "Resistor", "position": "4,4"},{"name": "Lightbulb", "position": "12,6"}],"wires": []}
                        hints: [
                            'You can use any of the components and change any values.'
                            'You\'ll need to adjust the voltage of the battery or the resistance in one of the components or both.'
                            'For example you could set the voltage in the battery to 6 Volts and change the resistance in the lightbulb to 10 Ohms.'
                        ]
                        completeInstructions: {"components": [{"name": "Battery", "position": "8,10"},{"name": "Resistor", "position": "4,4"},{"name": "Lightbulb", "position": "12,6"}],"wires": [["9,10","10,10"],["10,10","11,10"],["11,10","12,10"],["12,10","13,10"],["13,10","13,9"],["13,9","13,8"],["13,8","13,7"],["13,7","13,6"],["12,6","11,6"],["11,6","10,6"],["10,6","9,6"],["9,6","8,6"],["8,6","8,7"],["8,7","8,8"],["8,8","8,9"],["8,9","8,10"]]}
                        completeValues: [["Battery",0.6]]
                        complete: '''
                            <p>There are a number of ways to create a circuit with 0.6 Amps.</p>
