        ...
        stages: [
            {
                ...
                levels: [
                    ...
                    }
                    {
                        ...
                        instructions: {"components": [{"name": "Battery", "position": "12,9", "voltage": 12},{"name": "Battery", "position": "6,9"},{"name": "Resistor", "position": "6,2"},{"name": "Lightbulb", "position": "12,4"}],"wires": []}
                        hints: [
                            'The amount of current (Amps) in the circuit is displayed on the tag of each component.'
                ...
                levels: [
                    {
                        ...
                        hints: [
                            ...
                            'Two lightbulbs placed in series add twice as much resistance to the circuit as one lightbulb would.'
