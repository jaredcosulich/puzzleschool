...
/*!
    ...
    * license MIT
    */
;!function(a,b){typeof module!="undefined"?module.exports=b():typeof define=="function"&&define.amd?define(a,b):this[a]=b()}("reqwest",function(){function handleReadyState(a,b,c){return function(){a&&a[readyState]==4&&(twoHundo.test(a.status)?b(a):c(a))}}function setHeaders(a,b){var c=b.headers||{},d;c.Accept=c.Accept||defaultHeaders.accept[b.type]||defaultHeaders.accept["*"];!b.crossOrigin&&!c[requestedWith]&&(c[requestedWith]=defaultHeaders.requestedWith);c[contentType]||(c[contentType]=b.contentType||defaultHeaders.contentType);for(d in c)c.hasOwnProperty(d)&&a.setRequestHeader(d,c[d])}function generalCallback(a){lastValue=a}function urlappend(a,b){return a+(/\?/.test(a)?"&":"?")+b}function handleJsonp(a,b,c,d){var e=uniqid++,f=a.jsonpCallback||"callback",g=a.jsonpCallbackName||"reqwest_"+e,h=new RegExp("((^|\\?|&)"+f+")=([^&]+)"),i=d.match(h),j=doc.createElement("script"),k=0;i?i[3]==="?"?d=d.replace(h,"$1="+g):g=i[3]:d=urlappend(d,f+"="+g);win[g]=generalCallback;j.type="text/javascript";j.src=d;j.async=!0;if(typeof j.onreadystatechange!="undefined"){j.event="onclick";j.htmlFor=j.id="_reqwest_"+e}j.onload=j.onreadystatechange=function(){if(j[readyState]&&j[readyState]!=="complete"&&j[readyState]!=="loaded"||k)return!1;j.onload=j.onreadystatechange=null;j.onclick&&j.onclick();a.success&&a.success(lastValue);lastValue=undefined;head.removeChild(j);k=1};head.appendChild(j)}function getRequest(a,b,c){var d=(a.method||"GET").toUpperCase(),e=typeof a=="string"?a:a.url,f=a.processData!==!1&&a.data&&typeof a.data!="string"?reqwest.toQueryString(a.data):a.data||null,g;if((a.type=="jsonp"||d=="GET")&&f){e=urlappend(e,f);f=null}if(a.type=="jsonp")return handleJsonp(a,b,c,e);g=xhr();g.open(d,e,!0);setHeaders(g,a);g.onreadystatechange=handleReadyState(g,b,c);a.before&&a.before(g);g.send(f);return g}function Reqwest(a,b){this.o=a;this.fn=b;init.apply(this,arguments)}function setType(a){var b=a.match(/\.(json|jsonp|html|xml)(\?|$)/);return b?b[1]:"js"}function init(o,fn){function complete(a){o.timeout&&clearTimeout(self.timeout);self.timeout=null;o.complete&&o.complete(a)}function success(resp){var r=resp.responseText;if(r)switch(type){case"json":try{resp=win.JSON?win.JSON.parse(r):eval("("+r+")")}catch(err){return error(resp,"Could not parse JSON in response",err)}break;case"js":resp=eval(r);break;case"html":resp=r}fn(resp);o.success&&o.success(resp);complete(resp)}function error(a,b,c){o.error&&o.error(a,b,c);complete(a)}this.url=typeof o=="string"?o:o.url;this.timeout=null;var type=o.type||setType(this.url),self=this;fn=fn||function(){};o.timeout&&(this.timeout=setTimeout(function(){self.abort()},o.timeout));this.request=getRequest(o,success,error)}function reqwest(a,b){return new Reqwest(a,b)}function normalize(a){return a?a.replace(/\r?\n/g,"\r\n"):""}function serial(a,b){var c=a.name,d=a.tagName.toLowerCase(),e=function(a){a&&!a.disabled&&b(c,normalize(a.attributes.value&&a.attributes.value.specified?a.value:a.text))};if(a.disabled||!c)return;switch(d){case"input":if(!/reset|button|image|file/i.test(a.type)){var f=/checkbox/i.test(a.type),g=/radio/i.test(a.type),h=a.value;(!f&&!g||a.checked)&&b(c,normalize(f&&h===""?"on":h))}break;case"textarea":b(c,normalize(a.value));break;case"select":if(a.type.toLowerCase()==="select-one")e(a.selectedIndex>=0?a.options[a.selectedIndex]:null);else for(var i=0;a.length&&i<a.length;i++)a.options[i].selected&&e(a.options[i])}}function eachFormElement(){var a=this,b,c,d,e=function(b,c){for(var e=0;e<c.length;e++){var f=b[byTag](c[e]);for(d=0;d<f.length;d++)serial(f[d],a)}};for(c=0;c<arguments.length;c++){b=arguments[c];/input|select|textarea/i.test(b.tagName)&&serial(b,a);e(b,["input","select","textarea"])}}function serializeQueryString(){return reqwest.toQueryString(reqwest.serializeArray.apply(null,arguments))}function serializeHash(){var a={};eachFormElement.apply(function(b,c){if(b in a){a[b]&&!isArray(a[b])&&(a[b]=[a[b]]);a[b].push(c)}else a[b]=c},arguments);return a}var win=window,doc=document,twoHundo=/^20\d$/,byTag="getElementsByTagName",readyState="readyState",contentType="Content-Type",requestedWith="X-Requested-With",head=doc[byTag]("head")[0],uniqid=0,lastValue,xmlHttpRequest="XMLHttpRequest",isArray=typeof Array.isArray=="function"?Array.isArray:function(a){return a instanceof Array},defaultHeaders={contentType:"application/x-www-form-urlencoded",accept:{"*":"text/javascript, text/html, application/xml, text/xml, */*",xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript",js:"application/javascript, text/javascript"},requestedWith:xmlHttpRequest},xhr=win[xmlHttpRequest]?function(){return new XMLHttpRequest}:function(){return new ActiveXObject("Microsoft.XMLHTTP")};Reqwest.prototype={abort:function(){this.request.abort()},retry:function(){init.call(this,this.o,this.fn)}};reqwest.serializeArray=function(){var a=[];eachFormElement.apply(function(b,c){a.push({name:b,value:c})},arguments);return a};reqwest.serialize=function(){if(arguments.length===0)return"";var a,b,c=Array.prototype.slice.call(arguments,0);a=c.pop();a&&a.nodeType&&c.push(a)&&(a=null);a&&(a=a.type);a=="map"?b=serializeHash:a=="array"?b=reqwest.serializeArray:b=serializeQueryString;return b.apply(null,c)};reqwest.toQueryString=function(a){var b="",c,d=encodeURIComponent,e=function(a,c){b+=d(a)+"="+d(c)+"&"};if(isArray(a))for(c=0;a&&c<a.length;c++)e(a[c].name,a[c].value);else for(var f in a){if(!Object.hasOwnProperty.call(a,f))continue;var g=a[f];if(isArray(g))for(c=0;c<g.length;c++)e(f,g[c]);else e(f,a[f])}return b.replace(/&$/,"").replace(/%20/g,"+")};reqwest.compat=function(a,b){if(a){a.type&&(a.method=a.type)&&delete a.type;a.dataType&&(a.type=a.dataType);a.jsonpCallback&&(a.jsonpCallbackName=a.jsonpCallback)&&delete a.jsonpCallback;a.jsonp&&(a.jsonpCallback=a.jsonp)}return new Reqwest(a,b)};return reqwest});provide("reqwest",module.exports);!function(a){var b=require("reqwest"),c=function(a){return function(){var c=Array.prototype.slice.call(arguments,0),d=this&&this.length||0;while(d--)c.unshift(this[d]);return b[a].apply(null,c)}},d=c("serialize"),e=c("serializeArray");a.ender({ajax:b,serialize:b.serialize,serializeArray:b.serializeArray,toQueryString:b.toQueryString});a.ender({serialize:d,serializeArray:e},!0)}(ender)})();(function(){var a={exports:{}},b=a.exports,c;c=typeof b!="undefined"&&b!==null?b:this.route={};c.Router=function(){function a(){this.routes=[]}a.name="Router";a.prototype._transformations=[[/([?=,\/])/g,"\\$1"],[/:([\w\d]+)/g,"([^/]*)"],[/\*([\w\d]+)/g,"(.*?)"]];a.prototype.add=function(a){var b,c,d,e,f,g,h,i,j;for(b in a){c=a[b];d="^"+b+"$";i=this._transformations;for(g=0,h=i.length;g<h;g++){j=i[g],f=j[0],e=j[1];d=d.replace(f,e)}this.routes.push({expr:b,pattern:new RegExp(d),fn:c})}};a.prototype.run=function(a,b){var c,d,e,f,g,h;d=[];h=this.routes;for(f=0,g=h.length;f<g;f++){e=h[f];(c=e.pattern.exec(a))&&d.push(e.fn.apply(b,c.slice(1)))}return d};return a}();provide("route",a.exports)})();(function(){var a={exports:{}},b=a.exports;provide("ender-remove",a.exports);(function(a){var b,c,d,e,f;f=a(""),b=f.empty,c=f.remove,d=f.replaceWith;e=function(b){b.deepEach(function(b){a(b).trigger("remove").unbind()})};return a.ender({empty:function(){e(this.children());return b.apply(this,arguments)},remove:function(){e(this);return c.apply(this,arguments)},replaceWith:function(){e(this);return d.apply(this,arguments)}},!0)})(ender)})();(function(){var a={exports:{}},b=a.exports,c;c=typeof b!="undefined"&&b!==null?b:this.jar={};c.Jar=function(){function a(){}a.name="Jar";a.prototype.parse=function(){var a,b,c,d,e,f;this.cookies={};b=this._getCookies();if(!b)return;f=[];for(d=0,e=b.length;d<e;d++){a=b[d];c=a.match(/([^=]+)=(.*)/);Array.isArray(c)?f.push(this.cookies[c[1]]=c[2]):f.push(void 0)}return f};a.prototype.get=function(a){try{return JSON.parse(decodeURIComponent(this.cookies[a]))}catch(b){}};a.prototype.set=function(a,b,c){var d,e,f,g,h,i,j;c==null&&(c={});if(b===null){b="";c.expires=-86400}if(c.expires){if(typeof c.expires=="number"){e=new Date;e.setTime(e.getTime()+c.expires*1e3);c.expires=e}c.expires instanceof Date&&(c.expires=c.expires.toUTCString())}h=c.expires?"; expires="+c.expires:"";i=c.path?"; path="+c.path:"";f=c.domain?"; domain="+c.domain:"";j=c.secure?"; secure":"";g=encodeURIComponent(JSON.stringify(b));d=[a,"=",g,h,i,f,j].join("");return this._setCookie(d)};return a}();(typeof process!="undefined"&&process!==null?process.pid:void 0)&&require("./node");provide("jar",a.exports);var d={}.hasOwnProperty,e=function(a,b){function e(){this.constructor=a}for(var c in b)d.call(b,c)&&(a[c]=b[c]);e.prototype=b.prototype;a.prototype=new e;a.__super__=b.prototype;return a};(function(a){var b,c;c=require("jar");c.Jar=function(a){function b(){return b.__super__.constructor.apply(this,arguments)}e(b,a);b.name="Jar";b.prototype._getCookies=function(){return document.cookie};b.prototype._setCookie=function(a){return document.cookie=a};b.prototype.get=function(a){this.parse();return b.__super__.get.apply(this,arguments)};return b}(c.Jar);b=c.jar=new c.Jar;return a.ender({cookie:function(a,c,d){return c!=null?b.set(a,c,d):b.get(a)}})})(ender)})();(function(){var a={exports:{}},b=a.exports;(function(){var a,c,d,e,f,g={}.hasOwnProperty,h=function(a,b){function d(){this.constructor=a}for(var c in b)g.call(b,c)&&(a[c]=b[c]);d.prototype=b.prototype;a.prototype=new d;a.__super__=b.prototype;return a},i=[].indexOf||function(a){for(var b=0,c=this.length;b<c;b++)if(b in this&&this[b]===a)return b;return-1};f=typeof b!="undefined"&&b!==null?b:this.soma={};d=require("events");f.Router=require("route").Router;f.router=new f.Router;f.routes=function(a){return f.router.add(a)};a=function(a,b,c){var d,e,g,i,j;if(Array.isArray(c)){d=c;c={};for(i=0,j=d.length;i<j;i++){e=d[i];c[e.name]=e}}for(g in c){e=c[g];typeof e=="object"&&(e=function(a){function d(){return d.__super__.constructor.apply(this,arguments)}var b,c;h(d,a);for(b in e){c=e[b];d.prototype[b]=c}return d}(a));e.prototype._src=f._src;e.name||(e.name=g);b[g]=e}};f.chunks=function(b){return a(f.Chunk,f.chunks,b)};f.views=function(b){return a(f.View,f.views,b)};e=function(a,b){var c,d,e;e=[];for(c in b){d=b[c];e.push(a[c]=d)}return e};c=function(a){return a&&a.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase()};f.EventMonitor=function(a){function b(){var a,b,c,d;d=this.events;for(b=0,c=d.length;b<c;b++){a=d[b];a in this&&this.on(a,this[a])}}h(b,a);b.name="EventMonitor";b.prototype.events=[];return b}(d.EventEmitter);f.Widget=function(a){function b(a){this.options={};e(this.options,this.defaults);e(this.options,a);b.__super__.constructor.call(this,this.options);this.status=null}h(b,a);b.name="Widget";b.prototype.defaults={};b.prototype.emit=function(a){i.call(this.events,a)>=0&&(this.status=a);return b.__super__.emit.apply(this,arguments)};return b}(f.EventMonitor);f.Context=function(){function a(){}a.name="Context";return a}();f.View=function(a){function b(){var a=this;b.__super__.constructor.apply(this,arguments);this.context=this.options.context||f.context;this.cookies=this.context.jar;this.go=function(){return a.context.go.apply(a.context,arguments)};this.name=c(this.constructor.name);this.el=$(this.options.el);this.el.data(this.name,this);this.el.one("remove",function(b){if(b.target===a.el[0]){a.el.data(a.name,null);return a.emit("destroy")}});this.emit("create")}h(b,a);b.name="View";b.prototype.events=["create","destroy"];b.prototype.$=function(a){return $(a,this.el)};return b}(f.Widget);f.Chunk=function(a){function b(){b.__super__.constructor.apply(this,arguments);this.errors=[];this.waiting=0}h(b,a);b.name="Chunk";b.prototype.events=["prepare","loading","ready","error","build","complete","render"];b.prototype.load=function(a){var b=this;this.context=a;this.cookies=this.context.jar;this.go=function(){return b.context.go.apply(b.context,arguments)};if(!this.status){setTimeout(this.wait(),1);return this.emit("prepare",this.options)}};b.prototype.toString=function(){return this.html};b.prototype.error=function(){var a;a=Array.prototype.slice.call(arguments);return this.errors.push(a)};b.prototype.ready=function(){if(!this.html){this.emit("build",this.errors);return this.emit("complete")}};b.prototype.wait=function(a){var b=this;this.waiting++||this.emit("loading");return function(){a&&a.apply(b,arguments);if(!--b.waiting)return b.emit("ready")}};b.prototype.loadChunk=function(a,b){typeof a=="function"?a=new a(b):typeof a=="string"&&(a=new f.chunks[a](b));if(!a.html){a.on("complete",this.wait());a.load(this.context)}return a};return b}(f.Widget);(typeof process!="undefined"&&process!==null?process.pid:void 0)&&require("./node")}).call(this);provide("soma",a.exports);(function(){var a,b,c,d,e={}.hasOwnProperty,f=function(a,b){function d(){this.constructor=a}for(var c in b)e.call(b,c)&&(a[c]=b[c]);d.prototype=b.prototype;a.prototype=new d;a.__super__=b.prototype;return a};b=require("jar");d=require("soma");d.Chunk=function(b){function c(){return c.__super__.constructor.apply(this,arguments)}f(c,b);c.name="Chunk";c.prototype.complete=function(){this.el||(this.el=a(this.html));return this.el.data("view",this)};c.prototype.loadElement=function(b,c,d,e){var f,g,h,i,j=this;i=b==="img"||b==="script"?"src":"href";h=c[i];h&&(g=a("head ["+i+'="'+h+'"], head [data-'+i+'="'+h+'"]'));if(g.length)"type"in c&&c.type!==g.attr("type")&&g.detach().attr("type",c.type).appendTo(a("head"));else{g=a(document.createElement(b));if("type"in c){if(!h)g.text(d);else if(c.type==="text/javascript")g.attr("async","async");else{g.attr("data-"+i,h);delete c[i];a.ajax({method:"GET",url:""+h,type:"html",success:function(a){g.text(a);return g.trigger("load")},error:function(a,b,c,d){return g.trigger("error")}})}a("head").append(g)}if(h&&h.substr(0,5)!=="data:"){g.attr("data-loading","loading");g.bind("load error",function(){return g.removeAttr("data-loading")})}g.attr(c)}if(g.attr("data-loading")){f=this.wait(e);g.bind("load",function(){return f(g)});g.bind("error",function(){j.emit("error","loadElement",b,c,d);return f(g)})}else e&&e(g);return g};c.prototype.setTitle=function(b){return a("title").text(b)};c.prototype.setMeta=function(b,c){var d,e;if(typeof b=="string"){e=b;b={name:e,value:c}}d=a('meta[name="'+b.name+'"]');if(!d.length){d=a(document.createElement("meta"));a("head").append(d)}d.attr(b);return d};c.prototype.loadScript=function(a,b){typeof a=="string"&&(a={src:a});a.type="text/javascript";return this.loadElement("script",a,null,b)};c.prototype.loadStylesheet=function(a){typeof a=="string"&&(a={href:a});a.type="text/css";a.rel="stylesheet";return this.loadElement("link",a)};c.prototype.loadTemplate=function(a){var b;typeof a=="string"&&(a={src:a});a.type="text/html";b=this.loadElement("script",a);b.toString=function(){return b.html()};return b};c.prototype.loadImage=function(a){var b;typeof a=="string"&&(a={src:a});b=this.loadElement("img",a);b.toString=function(){return b.outerHTML()};return b};c.prototype.loadData=function(b){var c,d,e,f,g=this;d={};b.method||(b.method="GET");b.type="json";b.headers||(b.headers={});if(b.data&&typeof b.data!="string"){b.headers["Content-Type"]="application/json";b.data=JSON.stringify(b.data)}c=this.wait();f=b.success;e=b.error;b.success=function(a){var b,e,g;for(e=0,g=a.length;e<g;e++){b=a[e];d[b]=a[b]}f&&f(a);return c()};b.error=function(a){e?e(a.status,a.response,b):g.emit("error","requireData",a.status,a.response,b);return c()};a.ajax(b);return d};return c}(d.Chunk);d.BrowserContext=function(c){function e(a,c){this.path=a;this.lazy=c;this.jar=b.jar}f(e,c);e.name="BrowserContext";e.prototype.begin=function(){var a,b,c,e;b=d.router.run(this.path,this);if(!b.length)throw new Error("No routes matched");for(c=0,e=b.length;c<e;c++){a=b[c];a instanceof d.Chunk&&this.send(a)}};e.prototype.send=function(a){if(!(a instanceof d.Chunk))throw new Error("Must send chunks");if(this.chunk)throw new Error("Cannot send multiple chunks");this.chunk=a;while(this.chunk.meta)this.chunk=this.chunk.meta();this.chunk.load(this);this.lazy||this.render()};e.prototype.render=function(){var b,c=this;if(!this.chunk)throw new Error("No chunk loaded");b=function(){c.chunk.emit("render");return a("body").html(c.chunk.html)};this.chunk.html?b():this.chunk.on("complete",b)};e.prototype.go=function(a,b){if(history.pushState)if(b)history.replaceState({},"",a);else{history.pushState({},"",a);window.onpopstate()}else document.location=a};return e}(d.Context);d=require("soma");a=ender;a.ender({view:function(a,b){return new d.views[a](b)},enhance:function(){return a(document).enhance()}});a.ender({view:function(b,c){c==null&&(c={});return this.each(function(){c.el=this;return a.view(b,c)})},enhance:function(){var b,c,f;f=d.views;for(b in f){if(!e.call(f,b))continue;c=f[b];a(c.prototype.selector,this).view(b)}},outerHTML:function(b){return b?this.each(function(){return a(this).replaceWith(b)}):this[0].outerHTML||(new XMLSerializer).serializeToString(this[0])}},!0);c=document.location.pathname;d.context=new d.BrowserContext(c);a("document").ready(function(){window.onpopstate=function(){if(document.location.pathname===c){c=null;return}d.context=new d.BrowserContext(document.location.pathname);d.context.begin()};return a.enhance()})}).call(this)})()