...
class SubscribersControllerTest < ActionController::TestCase
  ...
  test "should create subscriber" do
    assert_difference('Subscriber.count') do
      post :create, subscriber: { birthyear: @subscriber.birthyear, email: @subscriber.email, name: @subscriber.name, notes: @subscriber.notes }
    end
  ...
  test "should update subscriber" do
    patch :update, id: @subscriber, subscriber: { birthyear: @subscriber.birthyear, email: @subscriber.email, name: @subscriber.name, notes: @subscriber.notes }
    assert_redirected_to subscriber_path(assigns(:subscriber))
  end
