...
languageScramble.ChunkHelper = (function() {
  ...
  function ChunkHelper(levelName) {
    ...
    this.level = languageScramble.data[this.levelName];
...
languageScramble.ViewHelper = (function() {
  ...
  function ViewHelper(area, user, level) {
    this.area = area;
    this.user = user;
    this.level = level;
  }
  ...
  ViewHelper.prototype.updateProgress = function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      id = scrambleInfo.id;
      level = this.user.groups[this.group][id];
      if (level) {
