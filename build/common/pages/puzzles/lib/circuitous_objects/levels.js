        ...
        levels: [
          {
            ...
            hints: ['The lightbulb provides 5 Ohms of resistance. The resistor provides 10 Ohms of resistance.', 'The more resistance a circuit has, the less current it will have.', 'Add the lightbulb only to create a circuit with the maximum amount of current.'],
            completeInstructions: {
              "components": [
                {
                  "name": "Battery",
            ...
            complete: '<p>The lightbulb provides 5 Ohms of resistance while the resistor provides 10 Ohms of resistance.</p>\n<p>So the circuit will have the greatest amount of current with the lightbulb only in it.</p>',
            values: true
          }, {
            id: 1379614899596,
